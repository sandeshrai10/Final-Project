const headphones = [
  {
    ...
    specialFeatures:
      "Touch sensor controls, ambient sound control, and voice assistant integration",
    price: 249,
    brand: "apple",
    images: [
      "airpods_pro_front.png",
      "airpods_pro_side.png",
      "airpods_pro_case.png",
    ],
    currentImageIndex: 0,
  },
  {
    ...
    brand: "sony",
    images: [
      "sony_wh1000xm4_front.png",
      "sony_wh1000xm4_side.png",
      "sony_wh1000xm4_top.png",
    ],
    currentImageIndex: 0,
  },
  {
    ...
    specialFeatures:
      "Aware mode for hearing ambient sound, voice assistant support",
    price: 329,
    brand: "bose",
  ...
  },
  {
    ...
    noiseCancellation: "Active Noise Cancellation",
    batteryLife:
      "Up to 5.5 hours (with ANC on), additional 19.5 hours with charging case",
    specialFeatures:
      "Customizable sound via Jabra Sound+ app, strong connectivity",
    price: 229,
    brand: "jabra",
    images: [
      "jabra_elite85t_front.png",
      "jabra_elite85t_side.png",
      "jabra_elite85t_case.png",
    ],
    currentImageIndex: 0,
  },
  {
    ...
    specialFeatures:
      "Transparent Hearing mode, auto on/off when folding/unfolding",
    price: 399,
    brand: "sennheiser",
    images: [
      "sennheiser_momentum3_front.png",
      "sennheiser_momentum3_side.png",
      "sennheiser_momentum3_top.png",
    ],
    currentImageIndex: 0,
  },
  {
    ...
    specialFeatures:
      "Tile tracking, touch controls, rapid charge (10 minutes for 2 hours)",
    price: 129,
    brand: "skullcandy",
    images: [
      "skullcandy_indyanc_front.png",
      "skullcandy_indyanc_side.png",
      "skullcandy_indyanc_case.png",
    ],
    currentImageIndex: 0,
  },
];
    ...
    headphoneElement.innerHTML = `
                ...
                <div class="image-gallery">
                    <div class="main-image">
                        <img src="${
                          headphone.images[headphone.currentImageIndex]
                        }" alt="${headphone.name}" id="mainImage${
      headphone.id
    }" width="300" height="200">
                    </div>
                    <div class="arrows">
                        <button class="prev" onclick="changeHeadphoneImage(-1, ${
                          headphone.id
                        })">&#10094;</button>
                        <button class="next" onclick="changeHeadphoneImage(1, ${
                          headphone.id
                        })">&#10095;</button>
                    </div>
                </div>
                <ul>
                    ...
                    <li>${
                      headphone.specialFeatures
                        ? `Special Features: ${headphone.specialFeatures}`
                        : ""
                    }</li>
                </ul>
                <p><strong>Price: $${headphone.price}</strong></p>
                <button class="btn" onclick="checkHeadphoneAvailability(${
                  headphone.itemNumber
                })">Check Availability</button>
                <div class="rating" id="rating-button-${
                  headphone.itemNumber
                }" onclick="navigateToReviews(${headphone.itemNumber})">
                    Loading...
                </div>
            `;
...
window.changeHeadphoneImage = function (direction, headphoneId) {
  ...
  document.getElementById(`mainImage${headphoneId}`).src =
    headphone.images[headphone.currentImageIndex];
};
...
window.checkHeadphoneAvailability = function (itemNumber) {
  ...
  localStorage.setItem(
    "selectedHeadphoneImages",
    JSON.stringify(headphone.images)
  );
...
document.getElementById("apply-changes-btn").addEventListener("click", () => {
  ...
  if (category !== "all") {
    filteredHeadphones = headphones.filter(
      (headphone) => headphone.brand === category
    );
  }
