const tablets = [
  ...
  },
  {
    ...
    display:
      "11-inch Liquid Retina display (2388 x 1668 resolution) or 12.9-inch Liquid Retina XDR display (2732 x 2048 resolution)",
    storageOptions: "128GB, 256GB, 512GB, 1TB, or 2TB",
    camera:
      "12MP Wide and 10MP Ultra Wide rear cameras, 12MP TrueDepth front camera",
    price: 799,
    brand: "apple",
    images: ["front.png", "sideview.png", "top.png"],
    currentImageIndex: 0,
...
function displayTablets(tabletList) {
  ...
  tabletList.forEach((tablet) => {
    ...
    tabletElement.innerHTML = `
            ...
            <div class="image-gallery">
                <div class="main-image">
                    <img src="${
                      tablet.images[tablet.currentImageIndex]
                    }" alt="${tablet.name}" id="mainImage${
      tablet.itemNumber
    }" width="300" height="200">
                </div>
                <div class="arrows">
                    <button class="prev" onclick="changeTabletImage(-1, ${
                      tablet.itemNumber
                    })">&#10094;</button>
                    <button class="next" onclick="changeTabletImage(1, ${
                      tablet.itemNumber
                    })">&#10095;</button>
                </div>
            </div>
            ...
            <button class="btn" onclick="checkTabletAvailability(${
              tablet.itemNumber
            })">Check Availability</button>
            <div class="rating" id="rating-button-${
              tablet.itemNumber
            }" onclick="navigateToReviews(${tablet.itemNumber})">
                Loading...
            </div>
        `;
    ...
    fetchRatingSummary(tablet.itemNumber);
  });
}
