...
public class UserController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody User user) {
        ...
        //     return ResponseEntity.badRequest().body(new ApiResponse(false, "Phone number should not exceed 10 digits"));
        // }
        // if (String.valueOf(user.getPhoneNumber()).length() != 10) {
        //     return ResponseEntity.badRequest().body(new ApiResponse(false, "Phone number should be 10 digits"));
        // }
